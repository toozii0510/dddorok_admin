    ...
    children: [
      {
        ...
        children: [
          ...
          { id: 104, parent_id: 10, name: '베스트' },
          { id: 105, parent_id: 10, name: '가디건' },
        ],
      },
      {
        id: 11,
...
export const users: User[] = [
  { id: '1', name: '김관리자', email: 'admin@example.com', role: '관리자', status: '활성', lastLogin: '2024-04-10' },
  { id: '2', name: '이사용자', email: 'user@example.com', role: '일반', status: '활성', lastLogin: '2024-04-08' }
];
